    ...
    <div className="komunikacija-content">
      ...
      <div className="komunikacija-item kom-img">
        <div className="komunikacija-text">
          Ali veste, da je partnerski odnos sestavljen iz 50:50 doprinosa? A ne, kakšno olajšanje <span className="emoji">😉</span>. Se pravi, da ena oseba ne mora biti kriva za vse. Pa saj to v bistvu, nekje globoko v sebi, tudi že veste.
