    ...
    <div className="komunikacija-content">
      ...
      <div className="komunikacija-item kom-img">
        <div className="komunikacija-text">
          ...
          vzgoji otroka, se pogovarjata s prijatelji, ki že imajo to izkušnjo
          ipd. Lahko pa vaju je nosečnost tudi malce presenetila. Nič hudega,
          vseeno se podata na pot starševstva.
          <br />
          ...
          pri vzgoji otroka in šele potem so tu okolica, šola in družba. Mi ga
          »oblikujemo« in mu damo zdrave temelje za samostojno življenje. Mi mu
          moramo dati tisti pravi občutek varnosti in zaščite.
          <br />
          Tu poglejmo, zakaj se "zatikamo", se ne razumemo in kako to preseči.
        </div>
      </div>
      <div className="kom-img-desc">
        ...
        <picture className="kom-pict-img">
          <source
            srcSet="../assets/webp/kom-otrok.webp"
            alt="Logo"
            type="image/webp"
          />
          <img
