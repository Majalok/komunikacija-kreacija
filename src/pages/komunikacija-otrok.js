    ...
    <div className="komunikacija-content">
      ...
      <div className="komunikacija-item kom-img">
        <div className="komunikacija-text">
          ...
          <br />
          Mi kot starš, se moramo zavedati, da smo prvi v vrsti pri vzgoji in šele potem je okolica in družba. Mi ga »oblikujemo« in mu damo zdrave temelje za samostojno življenje. Mi mu moramo dati tisti pravi občutek varnosti in zaščite.
          <br />
