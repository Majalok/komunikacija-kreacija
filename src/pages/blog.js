        ...
        <div className="blog">
          <div className="blog-content">
            <div className="blog-item">
              ...
              brat, za povrh, da je mera polna  <img className="emoji-img" src="../icons/wink.png" width="30px" alt="" /> <img className="emoji-img" src="../icons/smile.png" width="30px" alt="" /> <img className="emoji-img" src="../icons/laugh.png" width="30px" alt="" /> <img className="emoji-img" src="../icons/sunglasses.png" width="30px" alt="" /> <img className="emoji-img" src="../icons/smile3.png" width="30px" alt="" />. Ja, prav vsi te učijo, usmerjajo in itak vedo kaj je najbolje zate.
